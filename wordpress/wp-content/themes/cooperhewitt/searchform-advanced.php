<?php
/**
 * Template Name: Search Form Advanced
 * 
...
<div class="row">
<div class="main">
<form class="search-form form<?php echo $form_classes; ?>" <?php echo $aria_label; ?>role="search" method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
<input type="hidden" name="action" value="get_api_data">
