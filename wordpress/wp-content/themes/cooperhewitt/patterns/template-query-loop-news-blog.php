 ...
 * Slug: cooperhewitt/template-query-loop-news-blog
 * Inserter: no
 *
 */
...
<div class="wp-block-group">
	...
	<p class="has-accent-4-color has-text-color has-link-color has-small-font-size"><?php echo esc_html_x( 'Written by', 'Prefix before the author name. The post author name is displayed in a separate block.', 'cooperhewitt' ); ?></p>
	<!-- /wp:paragraph -->
...
<!-- wp:query-pagination-previous {"label":"<?php esc_html_e( 'Newer Posts', 'cooperhewitt' ); ?>"} /-->

<!-- wp:query-pagination-numbers /-->

<!-- wp:query-pagination-next {"label":"<?php esc_html_e( 'Older Posts', 'cooperhewitt' ); ?>"} /-->
<!-- /wp:query-pagination --></div>
<!-- /wp:group -->

<!-- wp:query-no-results -->
<!-- wp:paragraph -->
<p><?php echo esc_html_x( 'Sorry, but nothing was found. Please try a search with different keywords.', 'Message explaining that there are no results returned from a search.', 'cooperhewitt' ); ?></p>
<!-- /wp:paragraph -->
<!-- /wp:query-no-results -->
