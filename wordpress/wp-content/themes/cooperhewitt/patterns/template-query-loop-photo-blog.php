 ...
 * Slug: cooperhewitt/template-query-loop-photo-blog
 * Categories: query
...
<div class="wp-block-query alignwide">
		...
		<p class="has-text-align-center"><?php echo esc_html_x( 'Sorry, but nothing was found. Please try a search with different keywords.', 'Message explaining that there are no results returned from a search.', 'cooperhewitt' ); ?></p>
		<!-- /wp:paragraph -->
		<!-- /wp:query-no-results -->
	</div>
	<!-- /wp:group -->
